  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following projects showcase my skills and experience throuugh real-world examples of my work.
          Each project is briefly described with links ot code repositories and live demos in it. It reflects my ability
